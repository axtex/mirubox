export type WatchlistStatus = "ALL" | "IN_PROGRESS" | "COMPLETED" | "PLANNED" | "ON_HOLD" | "DROPPED";
...
export function statusToSlug(status: WatchlistStatus): string {
  return status.toLowerCase().replace(/_/g, "-");
}

export function slugToStatus(slug: string): WatchlistStatus {
  return slug.toUpperCase().replace(/-/g, "_") as WatchlistStatus;
}
